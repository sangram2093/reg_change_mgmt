...
def get_summary_entities(text, version):
    ...
    prompt = f"""You are an AI assistant for analyzing financial regulation documents.
...
{{
  ...
  "relationships": [
    {{"subject_id": "E1", "verb": "must verify", "object_id": "E2", "confidence_score": 0.92}}
  ]
}}
...
"""
    ...
    if match:
        ...
        log_path = f"logs/{version}_graph.json"
